...
This is very different from what I imagined the curve would look like. I am interested in knowing if there is a reason that caused the spike in August. Is the weather to blame for it? Or is it because of a policy or social event in DC?
```{r}
